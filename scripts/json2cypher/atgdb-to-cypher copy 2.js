...
/*
 * Tester de créer la contrainte uniqueImportLabel sur node_id, et supprimer uniqument le label (et la contrainte)
 * une fois l'alimentation de la base de donnée fini.
 */

result += `:commit
:begin
MATCH (n:\`UNIQUE IMPORT LABEL\`) REMOVE n:\`UNIQUE IMPORT LABEL\` REMOVE n.\`UNIQUE IMPORT ID\`;
:commit
:begin
