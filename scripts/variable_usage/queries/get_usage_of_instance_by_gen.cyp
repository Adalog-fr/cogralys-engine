...
CALL {
  ...
  CALL {
    ...
    RETURN  var as Variable, isWriteInst, isReadInst, var.isWriteGen AS isWriteGen, var.isReadGen AS isReadGen
  }

  return instLoc as Location, Variable, isWriteInst, isReadInst, isWriteGen, isReadGen
}
