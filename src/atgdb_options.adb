...
package body Atgdb_Options is
   ...
   begin -- Analyse_Options
      ...
      Utilities.Debug_Option   := Atgdb_Options.Debug_Option.Value   = On;
      Utilities.Verbose_Option := Atgdb_Options.Verbose_Option.Value = On;
